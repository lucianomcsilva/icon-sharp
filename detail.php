<html>
   ...
   <body class="yui-skin-sam">
      ...
      <h1>How to Install</h1>
         <p> Just download the zip file (<a href="http://code.google.com/p/icon-sharp/">here</a>) into your Server directory and unzip it. Make sure you PHP with GD library and apache rewrite rules enabled. After your install you should access this page thought this link:</p> 
         <div class="divLink">         
